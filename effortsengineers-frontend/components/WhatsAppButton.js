...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      aria-label="Chat with Application Engineer on WhatsApp"
      title="Chat with Application Engineer on WhatsApp"
    >
      <svg
        width="20"
        height="20"
      ...
      <span className="whatsapp-btn-text">WhatsApp Engineer</span>
    </a>
  );
}
